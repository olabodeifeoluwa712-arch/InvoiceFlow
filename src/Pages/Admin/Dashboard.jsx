  ...
  return (
    <div className="bg-white rounded-3xl border border-slate-100 shadow-sm p-6 w-full">
      <div className="flex items-center justify-between mb-6">
        ...
        <button className="bg-purple-100/50 text-[#8B5CF6] font-semibold text-sm px-4 py-1.5 rounded-full cursor-default">
          2024
        </button>
      </div>
...
const Dashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-[#F8F9FC] p-6 md:p-10 font-sans select-none">
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          {/* Total Revenue */}
          <div className="bg-white rounded-3xl border border-slate-100 shadow-sm p-6 flex flex-col justify-between relative overflow-hidden">
            <div>
              <div className="flex items-center justify-between">
                ...
                <div className="w-10 h-10 rounded-xl bg-purple-100/50 flex items-center justify-center">
                  <span className="text-purple-600 font-extrabold text-xl leading-none">$</span>
                </div>
              </div>
              <h3 className="text-3xl font-extrabold text-slate-800 mt-4">
          ...
          <div className="bg-white rounded-3xl border border-slate-100 shadow-sm p-6 flex flex-col justify-between relative overflow-hidden">
            <div>
              <div className="flex items-center justify-between">
                <span className="text-sm font-semibold text-slate-400">Total Invoices</span>
            ...
            <div className="text-slate-400 text-sm font-semibold mt-6">
          ...
          <div className="bg-white rounded-3xl border border-slate-100 shadow-sm p-6 flex flex-col justify-between relative overflow-hidden">
            <div>
              <div className="flex items-center justify-between">
                <span className="text-sm font-semibold text-slate-400">Pending / Overdue</span>
            ...
            <div className="mt-3">
              <div className="text-slate-400 text-sm font-semibold">Requires attention</div>
              <div className="text-red-500 text-sm font-semibold flex items-center gap-1 mt-1">
          ...
          <div className="bg-white rounded-3xl border border-slate-100 shadow-sm p-6 flex flex-col justify-between relative overflow-hidden">
            <div>
              <div className="flex items-center justify-between">
                <span className="text-sm font-semibold text-slate-400">Low Stock Items</span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-4 bg-white rounded-3xl border border-slate-100 shadow-sm p-4 w-full h-full">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-xl font-bold text-slate-850">Recent Invoices</h2>
              <a href="#view-all" className="text-[#8B5CF6] hover:text-[#7C3AED] text-sm font-semibold transition-colors flex items-center gap-1">
              ...
              {recentInvoices.map((invoice) => (
                <div key={invoice.id} className="flex items-center justify-between">
                  <div className="flex items-center gap-3.5">
                    ...
                    <div className={`w-10 h-10 rounded-full flex items-center justify-center font-bold text-xs ${invoice.avatarBg}`}>
                      {invoice.initials}
                    </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-3xl border border-slate-100 shadow-sm p-6 w-full">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-xl font-bold text-slate-850">Low Stock Products</h2>
              <a href="#manage" className="text-[#8B5CF6] hover:text-[#7C3AED] text-sm font-semibold transition-colors flex items-center gap-1">
              ...
              {lowStockProducts.map((product) => (
                <div key={product.id} className="flex items-center justify-between">
                  <div className="flex items-center gap-3.5">
                    ...
                    <div className="w-10 h-10 rounded-full flex items-center justify-center bg-slate-50 border border-slate-100">
          ...
          <div className="bg-white rounded-3xl border border-slate-100 shadow-sm p-6 w-full">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-xl font-bold text-slate-850">Customer Activity</h2>
              <a href="#view-all" className="text-[#8B5CF6] hover:text-[#7C3AED] text-sm font-semibold transition-colors flex items-center gap-1">
                View all <span className="text-xs">→</span>
              </a>
            </div>
              ...
              {customerActivity.map((customer) => (
                <div key={customer.id} className="flex items-center justify-between">
                  <div className="flex items-center gap-3.5">
                    ...
                    <div className={`w-10 h-10 rounded-full flex items-center justify-center font-bold text-xs ${customer.avatarBg}`}>
                      {customer.initials}
                    </div>
                  ...
                  {customer.unpaidCount > 0 && (
                    <span className="inline-flex items-center justify-center px-3 py-0.5 rounded-full text-xs font-semibold border bg-amber-50 text-amber-700 border-amber-100">
